...
function() {
    ...
    function(t) {
        ...
        function o(o) {
            function s() {
                if (!d) {
                    ...
                    if (p = function() { var t = i ? function(t) { return i(t, null) } : function(t) { return t.currentStyle }; return function(e) { var i = t(e); return i || n("Style returned " + i + ". Are you running this code in a hidden iframe on Firefox? " + "See http://bit.ly/getsizeiframe"), i } }(), h = o("boxSizing")) {
        ...
        var n = "undefined" == typeof console ? noop : function(t) { console.error(t) },
